...
class Model:
    ...
    def transit_depth(self):
        ...
        for molecule in molecules:
            ...
            abundance_name = molecular_abundance_dict[molecule]
            integral_mol = self.integral_grid_interpolate(my_temp, temperature_array, pressure_levels, self.integral_dict[molecule]) * (10 ** self.parameter_dict[abundance_name])
        ...
        integral_grid_cia = self.integral_grid_interpolate(my_temp, temperature_array_cia, pressure_levels, self.integral_dict['cia'])
